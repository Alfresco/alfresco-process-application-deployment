...
|------------|------|---------|
| https://activiti.github.io/activiti-cloud-helm-charts | activiti-cloud-query(common) | 8.0.0-mock |
| https://activiti.github.io/activiti-cloud-helm-charts | runtime-bundle(common) | 8.0.0-mock |
| https://activiti.github.io/activiti-cloud-helm-charts | activiti-cloud-connector(common) | 8.0.0-mock |
| https://activiti.github.io/activiti-cloud-helm-charts | alfresco-admin-app(common) | 8.0.0-mock |
| https://activiti.github.io/activiti-cloud-helm-charts | alfresco-digital-workspace-app(common) | 8.0.0-mock |
...
| activiti-cloud-connector.image.tag | string | `"8.0.0-mock"` |  |
...
| activiti-cloud-query.image.tag | string | `"7.12.0-mock"` |  |
...
| alfresco-digital-workspace-app.image.tag | string | `"7.12.0-mock"` |  |
...
| runtime-bundle.image.tag | string | `"7.12.0-mock"` |  |
