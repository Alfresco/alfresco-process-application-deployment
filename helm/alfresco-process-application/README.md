...
| https://activiti.github.io/activiti-cloud-helm-charts | alfresco-digital-workspace-app(common) | 7.8.0-alpha.2 |
...
| activiti-cloud-query.image.tag | string | `"7.8.0-rc.26"` |  |
...
| alfresco-digital-workspace-app.image.tag | string | `"7.8.0-rc.26"` |  |
...
| runtime-bundle.image.tag | string | `"7.8.0-rc.26"` |  |
