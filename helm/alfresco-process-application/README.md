...
| activiti-cloud-query.image.tag | string | `"7.11.0-rc.19"` |  |
...
| alfresco-digital-workspace-app.image.tag | string | `"7.11.0-rc.19"` |  |
...
| runtime-bundle.image.tag | string | `"7.11.0-rc.19"` |  |
