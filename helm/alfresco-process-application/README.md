...
| https://activiti.github.io/activiti-cloud-helm-charts | alfresco-digital-workspace-app(common) | 8.8.0-alpha.27 |
...
| activiti-cloud-query.image.tag | string | `"7.20.0-rc.1004"` |  |
...
| alfresco-digital-workspace-app.image.tag | string | `"7.20.0-rc.1004"` |  |
...
| runtime-bundle.image.tag | string | `"7.20.0-rc.1004"` |  |
