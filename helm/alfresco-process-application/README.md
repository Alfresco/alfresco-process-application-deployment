...
| activiti-cloud-connector.image.tag | string | `"7.1.0-M13"` |  |
...
| activiti-cloud-query.image.tag | string | `"7.1.0-M13"` |  |
...
| alfresco-digital-workspace-app.image.tag | string | `"7.1.0-M13"` |  |
...
| alfresco-process-workspace-app.image.tag | string | `"7.1.0-M13"` |  |
...
| runtime-bundle.image.tag | string | `"7.1.0-M13"` |  |
