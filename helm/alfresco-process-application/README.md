...
| https://activiti.github.io/activiti-cloud-helm-charts | alfresco-digital-workspace-app(common) | 7.5.1 |
...
| activiti-cloud-query.image.tag | string | `"7.5.2-alpha.1"` |  |
...
| alfresco-digital-workspace-app.image.tag | string | `"7.5.0"` |  |
...
| runtime-bundle.image.tag | string | `"7.5.2-alpha.1"` |  |
