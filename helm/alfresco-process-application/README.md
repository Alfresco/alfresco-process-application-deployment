...
|------------|------|---------|
| https://activiti.github.io/activiti-cloud-helm-charts | activiti-cloud-query(common) | 7.14.0-rc.23 |
| https://activiti.github.io/activiti-cloud-helm-charts | runtime-bundle(common) | 7.14.0-rc.23 |
| https://activiti.github.io/activiti-cloud-helm-charts | activiti-cloud-connector(common) | 7.14.0-rc.23 |
| https://activiti.github.io/activiti-cloud-helm-charts | alfresco-admin-app(common) | 7.14.0-rc.23 |
| https://activiti.github.io/activiti-cloud-helm-charts | alfresco-digital-workspace-app(common) | 7.14.0-rc.23 |
...
| activiti-cloud-query.image.tag | string | `"7.14.0-mock"` |  |
...
| alfresco-digital-workspace-app.image.tag | string | `"7.14.0-mock"` |  |
...
| runtime-bundle.image.tag | string | `"7.14.0-mock"` |  |
