...
| activiti-cloud-query.image.tag | string | `"7.9.0-rc.24"` |  |
...
| alfresco-digital-workspace-app.image.tag | string | `"7.9.0-rc.24"` |  |
...
| runtime-bundle.image.tag | string | `"7.9.0-rc.24"` |  |
