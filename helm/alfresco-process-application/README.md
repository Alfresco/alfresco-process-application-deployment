...
| https://activiti.github.io/activiti-cloud-helm-charts | alfresco-digital-workspace-app(common) | 7.7.0-alpha.18 |
...
| activiti-cloud-query.image.tag | string | `"7.7.0-alpha.35"` |  |
...
| runtime-bundle.image.tag | string | `"7.7.0-alpha.35"` |  |
