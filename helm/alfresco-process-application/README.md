...
| activiti-cloud-query.image.tag | string | `"7.15.0-rc.20"` |  |
...
| alfresco-digital-workspace-app.image.tag | string | `"7.15.0-rc.20"` |  |
...
| runtime-bundle.image.tag | string | `"7.15.0-rc.20"` |  |
