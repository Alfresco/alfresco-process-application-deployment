...
| https://activiti.github.io/activiti-cloud-helm-charts | alfresco-digital-workspace-app(common) | 8.0.0 |
...
| activiti-cloud-query.image.tag | string | `"7.12.0"` |  |
...
| alfresco-digital-workspace-app.image.tag | string | `"7.12.0"` |  |
...
| runtime-bundle.image.tag | string | `"7.12.0"` |  |
