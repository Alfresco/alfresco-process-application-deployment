...
| activiti-cloud-query.image.tag | string | `"7.11.0-rc.3"` |  |
...
| alfresco-digital-workspace-app.image.tag | string | `"7.11.0-rc.3"` |  |
...
| runtime-bundle.image.tag | string | `"7.11.0-rc.3"` |  |
