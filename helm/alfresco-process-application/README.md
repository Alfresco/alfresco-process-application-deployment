...
| activiti-cloud-query.image.tag | string | `"7.21.0-rc.43"` |  |
...
| alfresco-digital-workspace-app.image.tag | string | `"7.21.0-rc.43"` |  |
...
| runtime-bundle.image.tag | string | `"7.21.0-rc.43"` |  |
