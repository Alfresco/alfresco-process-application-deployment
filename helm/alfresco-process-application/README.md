...
| https://activiti.github.io/activiti-cloud-helm-charts | alfresco-digital-workspace-app(common) | 9.1.0-alpha.1 |
...
| activiti-cloud-query.image.tag | string | `"7.21.0-rc.40"` |  |
...
| alfresco-digital-workspace-app.image.tag | string | `"7.21.0-rc.40"` |  |
...
| runtime-bundle.image.tag | string | `"7.21.0-rc.40"` |  |
