...
| activiti-cloud-query.image.tag | string | `"7.16.0-rc.35"` |  |
...
| alfresco-digital-workspace-app.image.tag | string | `"7.16.0-rc.35"` |  |
...
| runtime-bundle.image.tag | string | `"7.16.0-rc.35"` |  |
