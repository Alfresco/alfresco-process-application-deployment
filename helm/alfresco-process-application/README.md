...
|------------|------|---------|
| https://activiti.github.io/activiti-cloud-helm-charts | activiti-cloud-query(common) | 7.10.0-mock |
| https://activiti.github.io/activiti-cloud-helm-charts | runtime-bundle(common) | 7.10.0-mock |
| https://activiti.github.io/activiti-cloud-helm-charts | activiti-cloud-connector(common) | 7.10.0-mock |
| https://activiti.github.io/activiti-cloud-helm-charts | alfresco-admin-app(common) | 7.10.0-mock |
| https://activiti.github.io/activiti-cloud-helm-charts | alfresco-digital-workspace-app(common) | 7.10.0-mock |
...
| activiti-cloud-connector.image.tag | string | `"7.10.0-mock"` |  |
...
| activiti-cloud-query.image.tag | string | `"7.10.0-mock"` |  |
...
| alfresco-digital-workspace-app.image.tag | string | `"7.10.0-mock"` |  |
...
| runtime-bundle.image.tag | string | `"7.10.0-mock"` |  |
