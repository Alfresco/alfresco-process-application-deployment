...
| https://activiti.github.io/activiti-cloud-helm-charts | alfresco-digital-workspace-app(common) | 9.0.0-mock |
...
| activiti-cloud-query.image.tag | string | `"7.20.0-mock"` |  |
...
| alfresco-digital-workspace-app.image.tag | string | `"7.20.0-mock"` |  |
...
| runtime-bundle.image.tag | string | `"7.20.0-mock"` |  |
