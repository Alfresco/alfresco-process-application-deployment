...
| https://activiti.github.io/activiti-cloud-helm-charts | alfresco-digital-workspace-app(common) | 8.6.0-alpha.8 |
...
| activiti-cloud-query.image.tag | string | `"7.18.0-alpha.42"` |  |
...
| runtime-bundle.image.tag | string | `"7.18.0-alpha.42"` |  |
