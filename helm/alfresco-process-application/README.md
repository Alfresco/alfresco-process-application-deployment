...
| activiti-cloud-query.image.tag | string | `"7.19.1-alpha.2"` |  |
...
| alfresco-digital-workspace-app.image.tag | string | `"7.19.0"` |  |
...
| runtime-bundle.image.tag | string | `"7.19.1-alpha.2"` |  |
