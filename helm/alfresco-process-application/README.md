...
| https://activiti.github.io/activiti-cloud-helm-charts | alfresco-digital-workspace-app(common) | 7.9.1 |
...
| activiti-cloud-query.image.tag | string | `"7.9.3-SNAPSHOT"` |  |
...
| alfresco-digital-workspace-app.image.tag | string | `"7.9.2"` |  |
...
| runtime-bundle.image.tag | string | `"7.9.3-SNAPSHOT"` |  |
