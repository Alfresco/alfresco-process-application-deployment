...
| activiti-cloud-query.image.tag | string | `"7.1.0-M7"` |  |
...
| alfresco-digital-workspace-app.image.tag | string | `"7.1.0-M7"` |  |
...
| alfresco-process-workspace-app.image.tag | string | `"7.1.0-M7"` |  |
...
| runtime-bundle.image.tag | string | `"7.1.0-M7"` |  |
