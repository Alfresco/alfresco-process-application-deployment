...
| activiti-cloud-query.image.tag | string | `"7.13.0-rc.14"` |  |
...
| alfresco-digital-workspace-app.image.tag | string | `"7.13.0-rc.14"` |  |
...
| runtime-bundle.image.tag | string | `"7.13.0-rc.14"` |  |
