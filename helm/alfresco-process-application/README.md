...
| activiti-cloud-query.image.tag | string | `"7.8.0-rc.48"` |  |
...
| alfresco-digital-workspace-app.image.tag | string | `"7.8.0-rc.48"` |  |
...
| runtime-bundle.image.tag | string | `"7.8.0-rc.48"` |  |
