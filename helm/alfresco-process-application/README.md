...
| activiti-cloud-query.image.tag | string | `"7.14.0-rc.18"` |  |
...
| alfresco-digital-workspace-app.image.tag | string | `"7.14.0-rc.18"` |  |
...
| runtime-bundle.image.tag | string | `"7.14.0-rc.18"` |  |
