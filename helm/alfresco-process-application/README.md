...
| https://activiti.github.io/activiti-cloud-helm-charts | alfresco-digital-workspace-app(common) | 8.2.0-alpha.4 |
...
| activiti-cloud-query.image.tag | string | `"7.16.0-rc.26"` |  |
...
| alfresco-digital-workspace-app.image.tag | string | `"7.16.0-rc.26"` |  |
...
| runtime-bundle.image.tag | string | `"7.16.0-rc.26"` |  |
