...
| https://activiti.github.io/activiti-cloud-helm-charts | alfresco-digital-workspace-app(common) | 8.5.0-mock |
...
| activiti-cloud-query.image.tag | string | `"7.17.0-mock"` |  |
...
| alfresco-digital-workspace-app.image.tag | string | `"7.17.0-mock"` |  |
...
| runtime-bundle.image.tag | string | `"7.17.0-mock"` |  |
