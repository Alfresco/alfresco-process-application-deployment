...
| activiti-cloud-query.image.tag | string | `"7.9.0-rc.17"` |  |
...
| alfresco-digital-workspace-app.image.tag | string | `"7.9.0-rc.17"` |  |
...
| runtime-bundle.image.tag | string | `"7.9.0-rc.17"` |  |
