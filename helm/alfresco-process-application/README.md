...
| activiti-cloud-query.image.tag | string | `"7.15.0-rc.34"` |  |
...
| alfresco-digital-workspace-app.image.tag | string | `"7.15.0-rc.34"` |  |
...
| runtime-bundle.image.tag | string | `"7.15.0-rc.34"` |  |
