...
| https://activiti.github.io/activiti-cloud-helm-charts | alfresco-digital-workspace-app(common) | 8.1.0 |
...
| activiti-cloud-query.image.tag | string | `"7.13.0"` |  |
...
| alfresco-digital-workspace-app.image.tag | string | `"7.13.0"` |  |
...
| runtime-bundle.image.tag | string | `"7.13.0"` |  |
