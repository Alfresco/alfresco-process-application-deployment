...
| activiti-cloud-query.image.tag | string | `"7.16.0-mock"` |  |
...
| alfresco-digital-workspace-app.image.tag | string | `"7.16.0-mock"` |  |
...
| runtime-bundle.image.tag | string | `"7.16.0-mock"` |  |
