...
| activiti-cloud-connector.image.tag | string | `"devlop"` |  |
...
| activiti-cloud-query.image.tag | string | `"devlop"` |  |
...
| alfresco-admin-app.image.tag | string | `"devlop"` |  |
...
| alfresco-digital-workspace-app.image.tag | string | `"devlop"` |  |
...
| alfresco-process-workspace-app.image.tag | string | `"devlop"` |  |
...
| runtime-bundle.image.tag | string | `"devlop"` |  |
