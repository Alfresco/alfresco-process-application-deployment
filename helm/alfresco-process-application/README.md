...
| activiti-cloud-query.image.tag | string | `"7.9.0-rc.28"` |  |
...
| alfresco-digital-workspace-app.image.tag | string | `"7.9.0-rc.28"` |  |
...
| runtime-bundle.image.tag | string | `"7.9.0-rc.28"` |  |
