...
| activiti-cloud-query.image.tag | string | `"7.18.0-rc.22"` |  |
...
| alfresco-digital-workspace-app.image.tag | string | `"7.18.0-rc.22"` |  |
...
| runtime-bundle.image.tag | string | `"7.18.0-rc.22"` |  |
