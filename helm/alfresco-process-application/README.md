...
| https://activiti.github.io/activiti-cloud-helm-charts | alfresco-digital-workspace-app(common) | 8.4.0 |
...
| activiti-cloud-query.image.tag | string | `"7.16.0"` |  |
...
| alfresco-digital-workspace-app.image.tag | string | `"7.16.0"` |  |
...
| runtime-bundle.image.tag | string | `"7.16.0"` |  |
