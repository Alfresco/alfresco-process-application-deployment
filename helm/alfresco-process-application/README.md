...
| activiti-cloud-query.image.tag | string | `"7.17.0-rc.49"` |  |
...
| alfresco-digital-workspace-app.image.tag | string | `"7.17.0-rc.49"` |  |
...
| runtime-bundle.image.tag | string | `"7.17.0-rc.49"` |  |
