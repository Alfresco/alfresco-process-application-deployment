...
| https://activiti.github.io/activiti-cloud-helm-charts | alfresco-digital-workspace-app(common) | 8.3.0 |
...
| activiti-cloud-query.image.tag | string | `"7.15.2-alpha.2"` |  |
...
| alfresco-digital-workspace-app.image.tag | string | `"7.15.0"` |  |
...
| runtime-bundle.image.tag | string | `"7.15.2-alpha.2"` |  |
