...
| https://activiti.github.io/activiti-cloud-helm-charts | alfresco-digital-workspace-app(common) | 8.7.0-alpha.6 |
...
| activiti-cloud-query.image.tag | string | `"7.20.0-nightly-build.1"` |  |
...
| alfresco-digital-workspace-app.image.tag | string | `"7.20.0-nightly-build.1"` |  |
...
| runtime-bundle.image.tag | string | `"7.20.0-nightly-build.1"` |  |
