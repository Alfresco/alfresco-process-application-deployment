...
| https://activiti.github.io/activiti-cloud-helm-charts | alfresco-digital-workspace-app(common) | 7.11.0 |
...
| activiti-cloud-query.image.tag | string | `"7.11.1-alpha.2"` |  |
...
| alfresco-digital-workspace-app.image.tag | string | `"7.11.0"` |  |
...
| runtime-bundle.image.tag | string | `"7.11.1-alpha.2"` |  |
