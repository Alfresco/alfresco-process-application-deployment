...
| activiti-cloud-query.image.tag | string | `"7.21.0-rc.54"` |  |
...
| alfresco-digital-workspace-app.image.tag | string | `"7.21.0-rc.54"` |  |
...
| runtime-bundle.image.tag | string | `"7.21.0-rc.54"` |  |
