...
| https://activiti.github.io/activiti-cloud-helm-charts | alfresco-digital-workspace-app(common) | 7.7.0-alpha.21 |
...
| activiti-cloud-query.image.tag | string | `"7.7.0-rc.75"` |  |
...
| alfresco-digital-workspace-app.image.tag | string | `"7.7.0-rc.75"` |  |
...
| runtime-bundle.image.tag | string | `"7.7.0-rc.75"` |  |
