...
| https://activiti.github.io/activiti-cloud-helm-charts | alfresco-digital-workspace-app(common) | 7.3.0 |
...
| activiti-cloud-query.image.tag | string | `"7.4.0-alpha.4"` |  |
...
| alfresco-digital-workspace-app.image.tag | string | `"7.3.0"` |  |
...
| runtime-bundle.image.tag | string | `"7.4.0-alpha.4"` |  |
