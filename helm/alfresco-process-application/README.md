...
| activiti-cloud-query.image.tag | string | `"7.19.0-rc.186"` |  |
...
| alfresco-digital-workspace-app.image.tag | string | `"7.19.0-rc.186"` |  |
...
| runtime-bundle.image.tag | string | `"7.19.0-rc.186"` |  |
