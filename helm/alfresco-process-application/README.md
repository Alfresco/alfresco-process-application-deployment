...
| https://activiti.github.io/activiti-cloud-helm-charts | alfresco-digital-workspace-app(common) | 8.2.0-alpha.3 |
...
| activiti-cloud-query.image.tag | string | `"7.14.0-rc.15"` |  |
...
| alfresco-digital-workspace-app.image.tag | string | `"7.14.0-rc.15"` |  |
...
| runtime-bundle.image.tag | string | `"7.14.0-rc.15"` |  |
