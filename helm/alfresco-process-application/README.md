...
| global.keycloak.clientSecretName | string | `"activiti-keycloak-secret"` | Configure Keycloak Client Kubernetes Secret Name. Secret will be created if `useExistingClientSecret` set to false |
