...
| https://activiti.github.io/activiti-cloud-helm-charts | alfresco-digital-workspace-app(common) | 8.6.0-alpha.10 |
...
| activiti-cloud-query.image.tag | string | `"7.18.0-rc.109"` |  |
...
| alfresco-digital-workspace-app.image.tag | string | `"7.18.0-rc.109"` |  |
...
| runtime-bundle.image.tag | string | `"7.18.0-rc.109"` |  |
