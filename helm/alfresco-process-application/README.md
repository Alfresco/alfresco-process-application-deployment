...
| activiti-cloud-query.image.tag | string | `"7.19.1-mock"` |  |
...
| alfresco-digital-workspace-app.image.tag | string | `"7.19.1-test1"` |  |
...
| runtime-bundle.image.tag | string | `"7.19.1-mock"` |  |
