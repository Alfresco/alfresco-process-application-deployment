...
| activiti-cloud-query.image.tag | string | `"7.20.0-rc.774"` |  |
...
| alfresco-digital-workspace-app.image.tag | string | `"7.20.0-rc.774"` |  |
...
| runtime-bundle.image.tag | string | `"7.20.0-rc.774"` |  |
