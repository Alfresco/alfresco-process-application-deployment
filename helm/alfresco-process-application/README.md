...
| activiti-cloud-query.image.tag | string | `"7.12.0-rc.125"` |  |
...
| alfresco-digital-workspace-app.image.tag | string | `"7.12.0-rc.125"` |  |
...
| runtime-bundle.image.tag | string | `"7.12.0-rc.125"` |  |
