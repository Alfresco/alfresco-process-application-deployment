...
| https://activiti.github.io/activiti-cloud-helm-charts | alfresco-digital-workspace-app(common) | 8.7.1 |
...
| activiti-cloud-query.image.tag | string | `"7.19.4-mock"` |  |
...
| alfresco-digital-workspace-app.image.tag | string | `"7.19.5"` |  |
...
| runtime-bundle.image.tag | string | `"7.19.4-mock"` |  |
